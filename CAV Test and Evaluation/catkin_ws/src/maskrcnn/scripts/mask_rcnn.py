...
import sys
import random
if '/home/opt/ros/kinetic/lib/python2.7/dist-packages' in sys.path:
    sys.path.remove('/home/opt/ros/kinetic/lib/python2.7/dist-packages')
...
parser = argparse.ArgumentParser(
    description='Use this script to run Mask-RCNN object detection and segmentation')
parser.add_argument(
    '--image', help='/home/tongjirc/catkin_ws/src/yolo/giraffe.jpg')
parser.add_argument(
    '--video', help='/home/tongjirc/catkin_ws/src/yolo/run.mp4')
...
def drawBox(frame, classId, conf, left, top, right, bottom, classMask):
    ...
    # Comment the above line and uncomment the two lines below to generate
    # different instance colors
...
classesFile = "/home/tongjirc/catkin_ws/src/maskrcnn/mscoco_labels.names"
classes = None
with open(classesFile, 'rt') as f:
    classes = f.read().rstrip('\n').split('\n')

# Give the textGraph and weight files for the model
textGraph = "/home/tongjirc/catkin_ws/src/maskrcnn/mask_rcnn_inception_v2_coco_2018_01_28.pbtxt"
modelWeights = "/home/tongjirc/catkin_ws/src/maskrcnn/mask_rcnn_inception_v2_coco_2018_01_28/frozen_inference_graph.pb"
...
# Load the classes
colorsFile = "/home/tongjirc/catkin_ws/src/maskrcnn/colors.txt"
