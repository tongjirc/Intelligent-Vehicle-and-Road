...
"""autogenerated by genpy from tongjirc/tongjircActionResult.msg. Do not edit."""
import sys
...
class tongjircActionResult(genpy.Message):
  _md5sum = "61019e447a1d83a4fa7410860a41f245"
  _type = "tongjirc/tongjircActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tongjirc/tongjircResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(tongjircActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = tongjirc.msg.tongjircResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = tongjirc.msg.tongjircResult()
