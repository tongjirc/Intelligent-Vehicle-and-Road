...
"""autogenerated by genpy from tongjirc/tongjircActionFeedback.msg. Do not edit."""
import sys
...
class tongjircActionFeedback(genpy.Message):
  _md5sum = "277ef6270d9bca057c139acfa038c76b"
  _type = "tongjirc/tongjircActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tongjirc/tongjircFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(tongjircActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = tongjirc.msg.tongjircFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = tongjirc.msg.tongjircFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_f().pack(self.feedback.percent_completes))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.percent_completes,) = _get_struct_f().unpack(str[start:end])
      return self
