...
if("TRUE" STREQUAL "TRUE")
  set(ptam_SOURCE_PREFIX /home/tongjirc/catkin_ws/src/ethzasl_ptam/ptam)
  set(ptam_DEVEL_PREFIX /home/tongjirc/catkin_ws/devel)
  set(ptam_INSTALL_PREFIX "")
  set(ptam_PREFIX ${ptam_DEVEL_PREFIX})
else()
  set(ptam_SOURCE_PREFIX "")
  set(ptam_DEVEL_PREFIX "")
  set(ptam_INSTALL_PREFIX /home/tongjirc/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ptam' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'ptam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tongjirc/catkin_ws/src/ethzasl_ptam/ptam/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ptam_dep}_FOUND)
      find_package(${ptam_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ptam_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
