...
(cl:defclass <hedge_pos_ang> (roslisp-msg-protocol:ros-message)
  ((address
    :reader address
    :initarg :address
    :type cl:fixnum
...
(cl:defclass hedge_pos_ang (<hedge_pos_ang>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <hedge_pos_ang>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'hedge_pos_ang)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name marvelmind_nav-msg:<hedge_pos_ang> is deprecated: use marvelmind_nav-msg:hedge_pos_ang instead.")))

(cl:ensure-generic-function 'address-val :lambda-list '(m))
(cl:defmethod address-val ((m <hedge_pos_ang>))
...
(cl:defmethod timestamp_ms-val ((m <hedge_pos_ang>))
...
(cl:defmethod x_m-val ((m <hedge_pos_ang>))
...
(cl:defmethod y_m-val ((m <hedge_pos_ang>))
...
(cl:defmethod z_m-val ((m <hedge_pos_ang>))
...
(cl:defmethod flags-val ((m <hedge_pos_ang>))
...
(cl:defmethod angle-val ((m <hedge_pos_ang>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader marvelmind_nav-msg:angle-val is deprecated.  Use marvelmind_nav-msg:angle instead.")
  (angle m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <hedge_pos_ang>) ostream)
  "Serializes a message object of type '<hedge_pos_ang>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <hedge_pos_ang>) istream)
  "Deserializes a message object of type '<hedge_pos_ang>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<hedge_pos_ang>)))
  "Returns string type for a message object of type '<hedge_pos_ang>"
  "marvelmind_nav/hedge_pos_ang")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'hedge_pos_ang)))
  "Returns string type for a message object of type 'hedge_pos_ang"
  "marvelmind_nav/hedge_pos_ang")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<hedge_pos_ang>)))
  "Returns md5sum for a message object of type '<hedge_pos_ang>"
  "757a5c747784795643dfe2d2ca2ac03e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'hedge_pos_ang)))
  "Returns md5sum for a message object of type 'hedge_pos_ang"
  "757a5c747784795643dfe2d2ca2ac03e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<hedge_pos_ang>)))
  "Returns full string definition for message of type '<hedge_pos_ang>"
  (cl:format cl:nil "uint8 address~%int64 timestamp_ms~%float64 x_m~%float64 y_m~%float64 z_m~%uint8 flags~%float64 angle~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'hedge_pos_ang)))
  "Returns full string definition for message of type 'hedge_pos_ang"
  (cl:format cl:nil "uint8 address~%int64 timestamp_ms~%float64 x_m~%float64 y_m~%float64 z_m~%uint8 flags~%float64 angle~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <hedge_pos_ang>))
  (cl:+ 0
     1
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <hedge_pos_ang>))
  "Converts a ROS message object to a list"
  (cl:list 'hedge_pos_ang
