...
#define ACCEL_X_MIN ((float) -257)
#define ACCEL_X_MAX ((float) 257)
#define ACCEL_Y_MIN ((float) -257)
#define ACCEL_Y_MAX ((float) 313)
#define ACCEL_Z_MIN ((float) -325)
#define ACCEL_Z_MAX ((float) 253)

// Magnetometer (standard calibration mode)
// "magn x,y,z (min/max) = X_MIN/X_MAX  Y_MIN/Y_MAX  Z_MIN/Z_MAX"
#define MAGN_X_MIN ((float) -251)
#define MAGN_X_MAX ((float) 789)
#define MAGN_Y_MIN ((float) -471)
#define MAGN_Y_MAX ((float) 505)
#define MAGN_Z_MIN ((float) -158)
#define MAGN_Z_MAX ((float) 779)
...
#define GYRO_AVERAGE_OFFSET_X ((float) -50.22)
#define GYRO_AVERAGE_OFFSET_Y ((float) 148.39)
#define GYRO_AVERAGE_OFFSET_Z ((float) 18.17)
//
/*
// Calibration example:
