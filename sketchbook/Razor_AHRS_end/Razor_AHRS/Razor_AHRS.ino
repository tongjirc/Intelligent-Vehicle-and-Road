...
float ACCEL_X_MIN = -263;
float ACCEL_X_MAX = 249;
float ACCEL_Y_MIN = -265;
float ACCEL_Y_MAX = 271;
float ACCEL_Z_MIN = -288;
float ACCEL_Z_MAX = 240;

// Magnetometer (standard calibration mode)
// "magn x,y,z (min/max) = X_MIN/X_MAX  Y_MIN/Y_MAX  Z_MIN/Z_MAX"
float MAGN_X_MIN = -393;
float MAGN_X_MAX = 598;
float MAGN_Y_MIN = -532;
float MAGN_Y_MAX = 466;
float MAGN_Z_MIN = -407;
float MAGN_Z_MAX = 514;
...
float magn_ellipsoid_center[3] = {137.618,78.6194,1463051};
float magn_ellipsoid_transform[3][3] = {{0.769678,-0.0904515,0.0627873}, {-0.904515,0.941283,-0.0232047}, {0.0627873,-0.0232047,0.88412}};

// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
float GYRO_AVERAGE_OFFSET_X = -48.28;
float GYRO_AVERAGE_OFFSET_Y = 150.29;
float GYRO_AVERAGE_OFFSET_Z = 17.08;
