...
let tongjircFeedback = require('./tongjircFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class tongjircActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new tongjircFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = tongjircFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new tongjircActionFeedback(null);
    ...
    data.feedback = tongjircFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new tongjircActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = tongjircFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new tongjircFeedback()
    }
...
module.exports = tongjircActionFeedback;
