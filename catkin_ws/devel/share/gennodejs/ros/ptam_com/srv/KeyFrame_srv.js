...
class KeyFrame_srvRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type KeyFrame_srvRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type KeyFrame_srvRequest
    let len;
    let data = new KeyFrame_srvRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new KeyFrame_srvRequest(null);
...
class KeyFrame_srvResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type KeyFrame_srvResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type KeyFrame_srvResponse
    let len;
    let data = new KeyFrame_srvResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new KeyFrame_srvResponse(null);
...
module.exports = {
  Request: KeyFrame_srvRequest,
  Response: KeyFrame_srvResponse,
  md5sum() { return '1950b962db053cd38d36594521dda474'; },
  datatype() { return 'ptam_com/KeyFrame_srv'; }
};
